...
import { type StudentModel } from '../../src/student/rest/student-get.controller.js';
...
describe('GET /rest/:id', () => {
    ...
    test('Student zu vorhandener ID', async () => {
        ...
        // when
        const response: AxiosResponse<StudentModel> = await client.get(url);
    ...
    test('Kein Student zu nicht-vorhandener ID', async () => {
        // given
    ...
    test('Student zu vorhandener ID mit ETag', async () => {
        // given
