...
describe('DELETE /rest/studenten', () => {
    ...
    test('Vorhandener Student loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Student loeschen, aber ohne Token', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Student loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
